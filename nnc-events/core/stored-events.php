	...
	<form method="post">
	    <table class="form-table">
	    	<tbody>
		    	<tr>
					<th colspan="2">
						<h2><?php _e('Edit event:',NNC_TEXTDOMAIN);?></h2>
					</th>
				</tr>
		        ...
		        <tr>
			        <th class="NNC_entry_url"><?php _e('Event URL:',NNC_TEXTDOMAIN);?></th>
			        <td>
		        ...
		        <tr>
		            ...
		            <td>
		            	...
		            	<input name="update_event" type="submit" value="<?php _e('Update event',NNC_TEXTDOMAIN)?>" class="button-primary" />    
						<input type="hidden" name="action" value="save" />
						<a href="?page=nnc-events&tab=existing_events" class="button-secondary">Cancel</a>
		                </p>
		            </td>
		        </tr>
...
<table class="form-table">
	<tbody>
		<tr>
			<th colspan="2">
				<h2><?php _e('Upcoming events',NNC_TEXTDOMAIN);?></h2>
			</th>
		</tr>
	</tbody>
</table>
	...
	foreach($myevents as $details) { 
        ...
        <th class="eventtitle" colspan="3">
        	<form method="post" style="float: right;">
        		...
        		<button class="se-button" type="submit" name="edit" value="<?php _e('Edit',NNC_TEXTDOMAIN);?>"><span class="dashicons dashicons-edit"></span></button>
        		<button class="se-button" type="submit" name="delete" value="<?php _e('Remove',NNC_TEXTDOMAIN);?>"><span class="dashicons dashicons-trash"></span></button>
...
<?php } // end foreach stored events display table
	...
	<?php if($i < 1) { ?> 
		<p class="se-empty-list">You currently have no upcoming events. 
			<a href="?page=nnc-events&tab=new_events" class="button-primary"><?php _e('Add event',NNC_TEXTDOMAIN);?></a>
		</p>
	<?php } ?>
...
<table class="form-table">
	<tbody>
		<tr>
			<th colspan="2">
				<h2><?php _e('Past events',NNC_TEXTDOMAIN);?></h2>
			</th>
		</tr>
	</tbody>
</table>
...
<?php if($i < 1) { ?>
	<p class="se-empty-list"><?php _e('Your past events list is empty.',NNC_TEXTDOMAIN);?></p>
<?php }
...
// end check if anything was stored in the DB 
	...
	<table class="form-table">
		<tbody>
			<tr>
				<th colspan="2">
					<h2><?php _e('All events',NNC_TEXTDOMAIN);?></h2>
				</th>
			</tr>
		</tbody>
	</table>
	<p class="se-empty-list se-center margin-bottom"><?php _e('You have no stored events.',NNC_TEXTDOMAIN);?> <a href="?page=nnc-events&tab=new_events" class="button-primary"><?php _e('Add event',NNC_TEXTDOMAIN);?></a></p><hr>
<?php } ?>
</div>